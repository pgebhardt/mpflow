...
namespace numeric {
    ...
    // helper methods
    public:
        static void addScalar(Matrix<dtype::real>* vector, Matrix<dtype::real>* scalar, dtype::size rows,
            dtype::size columns, cudaStream_t stream=NULL);
        static void updateVector(Matrix<dtype::real>* result, Matrix<dtype::real>* x1, dtype::real sign,
            Matrix<dtype::real>* x2, Matrix<dtype::real>* r1, Matrix<dtype::real>* r2, cudaStream_t stream=NULL);
        static void gemv(Matrix<dtype::real>* result,
            Matrix<dtype::real>* matrix, Matrix<dtype::real>* vector, cudaStream_t stream=NULL);
