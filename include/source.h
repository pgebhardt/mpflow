...
namespace fastEIT {
    ...
    namespace source {
        ...
        public:
            ...
            // accessors
            const std::shared_ptr<Matrix<dtype::real>> drive_pattern() const { return this->drive_pattern_; }
            const std::shared_ptr<Matrix<dtype::real>> measurement_pattern() const { return this->measurement_pattern_; }
