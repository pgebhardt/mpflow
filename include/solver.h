...
namespace fastEIT {
    ...
    public:
        ...
        const std::shared_ptr<ForwardSolver<BasisFunction, numeric::SparseConjugate>> forward_solver() const {
        ...
        std::shared_ptr<ForwardSolver<BasisFunction, numeric::SparseConjugate>> forward_solver() {
            return this->forward_solver_;
        }
    ...
    private:
        ...
        std::shared_ptr<ForwardSolver<BasisFunction, numeric::SparseConjugate>> forward_solver_;
