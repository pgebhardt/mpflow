...
__kernel void calc_image_phi(__global float* image, __global float* elements, __global float* phi,
...
__kernel void calc_image_sigma(__global float* image, __global float* elements, __global float* sigma,
    unsigned int size_x, unsigned int size_y, float radius) {
    // get id
    unsigned int k = get_global_id(0);
