...
# Object files
_OBJ = mesh.o basis.o electrodes.o grid.o conjugate.o sparse_conjugate.o forward.o inverse.o solver.o
OBJ = $(patsubst %, $(BUILD)/%, $(_OBJ))

# Cuda object files
_CUOBJ = grid.cu_o conjugate.cu_o forward.cu_o
CUOBJ = $(patsubst %, $(BUILD)/%, $(_CUOBJ))

# Dependencies
_DEPS = fasteit.h mesh.h basis.h electrodes.h grid.h conjugate.h sparse_conjugate.h forward.h inverse.h solver.h
