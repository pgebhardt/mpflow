...
# Object files
_OBJ = mesh.o electrodes.o basis.o conjugate.o sparse_conjugate.o forward.o #inverse.o solver.o
...
# Dependencies
_DEPS = fasteit.hpp mesh.hpp basis.hpp electrodes.hpp model.hpp conjugate.hpp sparse_conjugate.hpp forward.hpp inverse.hpp solver.hpp
